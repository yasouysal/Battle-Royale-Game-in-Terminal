...
std::pair<int, int> createAndRunTest(Test testType, const std::string& inputFileName = "") {
    ...
    //cout << "run yapmadan oncesi" << endl;
    testToRun->run();
    //cout << "run yaptiktan sonrasi" << endl;
...
int main(int argc, char** argv) {
    ...
    //std::vector<Test> testToRun = { PLAYER, PARSER, BOARD, ENGINE };
    ...
    /*std::cout << testToRun.size() << std::endl;
    std::cout << testToRun[0] << std::endl;
    std::cout << testToRun[1] << std::endl;
    std::cout << testToRun[2] << std::endl;
    std::cout << testToRun[3] << std::endl;*/
